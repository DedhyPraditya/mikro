          ...
          <div  class="col-8">
                  ...
                  <div class="col-3 col-box-6">
                    <div class="box bg-red bmh-75">
                      <a onclick="cancelPage()" href="./?hotspot-user=generate&session=<?= $session; ?>">
                        <div>
                          <h1><i class="fa-solid fa-wand-magic-sparkles"></i>
                              <span style="font-size: 15px;"><?= $_generate ?></span>
                          </h1>
                        </div>
                        <div>
                            <i class="fa-solid fa-wand-magic-sparkles"></i> <?= $_hotspot_users ?>
                        </div>
                    </a>
                  </div>
                </div>
            ...
            <div id="r_4" class="row">
              <div <?= $lreport; ?> class="box bmh-75 box-bordered">
                <div class="box-group">
                  <div class="box-group-icon"><i class="fa-solid fa-money-bill"></i></div>
                    <div class="box-group-area">
                      <span >
