...
#### Update 01-13 2026 V3.21 - RouterOS 7 ONLY

1. **⚠️ BREAKING CHANGE**: Mikhmon sekarang hanya support RouterOS 7 dan RouterOS 6.43+

   - Tidak lagi support RouterOS versi lama (pre-6.43)
   - **Minimum requirement: RouterOS 6.43+ atau RouterOS 7.x**
   - Simplified authentication - hanya modern method (hapus MD5 challenge)
   - Kode lebih bersih dan mudah maintain (~17 lines dihapus)
   - Penambahan parameter `certless` untuk SSL connection
   - Perbaikan timeout handling untuk koneksi yang lebih stabil
   - File backup tersimpan di `lib/routeros_api.class.php.backup`

   **Jika masih menggunakan RouterOS versi lama:**

   - Upgrade RouterOS ke versi 6.43+ atau 7.x (recommended)
   - Atau gunakan backup file untuk rollback: `routeros_api.class.php.backup`
