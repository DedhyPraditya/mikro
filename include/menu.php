...
?>  
  ...
  <a class="connect menu <?= $shome; ?>" id="<?= $session; ?>&c=settings"><i class="fas fa-chart-line"></i> <?= $_dashboard ?></a>
...
<div id="sidenav" class="sidenav">
  ...
  <a href="./?session=<?= $session; ?>" class="menu <?= $shome; ?>"><i class="fa fa-chart-line"></i> <?= $_dashboard ?></a>
  <!--hotspot-->
  <div class="dropdown-btn <?= $susers . $suserprof . $sactive . $shosts . $sipbind . $scookies; ?>"><i class="fas fa-wifi"></i> Hotspot
  ...
  <div class="dropdown-container <?= $umenu; ?>">
    ...
    <a href="./?hotspot-user=generate&session=<?= $session; ?>" class="<?= $sgenuser; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa-solid fa-wand-magic-sparkles"></i> <?= $_generate ?> </a>        
  </div>
  <!--profile-->
  ...
  <!--PPP-->
    ...
    <div class="dropdown-container <?= $pppmenu; ?>">
      <a href="./?ppp=secrets&session=<?= $session; ?>" class="menu <?= $ssecrets; ?>"><i class="fa fa-key"></i> <?= $_ppp_secrets ?></a>
      <a href="./?ppp=profiles&session=<?= $session; ?>" class="menu <?= $spprofile; ?>"><i class="fa fa-user"></i> <?= $_ppp_profiles ?></a>
      <a href="./?ppp=active&session=<?= $session; ?>" class="menu <?= $spactive; ?>"><i class="fa fa-bolt"></i> <?= $_ppp_active ?></a>
    </div>
   <!--log-->
  ...
  <!--system-->
  <div class="dropdown-btn <?= $sysmenu; ?>"><i class="fa-solid fa-gears"></i> <?= $_system ?>
    <i class="fa fa-caret-down"></i> &nbsp;
  </div>
  <div class="dropdown-container <?= $schmenu; ?>">
    <a href="./?system=scheduler&session=<?= $session; ?>" class="<?= $ssch; ?>"> <i class="fa-solid fa-calendar-check"></i> <?= $_system_scheduler ?> </a>
  ...
  <!--report-->
  <a href="./?report=selling&idbl=<?= strtolower(date("M")) . date("Y"); ?>&session=<?= $session; ?>" class="menu <?= $sselling; ?>"><i class="fa-solid fa-bug"></i> <?= $_report ?></a>
  <!--settings-->
